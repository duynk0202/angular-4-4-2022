...
document.getElementsByClassName("cart-total-price")[0].innerText = total + '$'
  ...
  export class shoppingcart extends  shop{
  xoa(){
...
thanhtien(){
document.getElementsByClassName('thanh-toan')[0].addEventListener('click',function(){
  alert('Cảm ơn bạn đã thanh toán đơn hàng')
})
}
}
